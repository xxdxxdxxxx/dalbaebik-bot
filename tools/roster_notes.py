"""Two-row free-form notes under the upper roster squads."""
...
def install(a):
 ...
 def render(title,body):
  if request.path.startswith('/squads'):
   ...
   marker="<section class='sheet-col bottom'>";body=body.replace(marker,''.join(notes)+marker,1)+JS
