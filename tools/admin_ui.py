...
.top{{position:sticky;top:0;z-index:20;background:var(--bg);border-bottom:1px solid var(--line)}}.topin{{width:min(980px,calc(100% - 32px));margin:auto}}.wrap{{width:min(940px,calc(100% - 32px));margin:auto}}.layout-overview{{max-width:940px}}.layout-players{{max-width:820px}}.layout-day{{max-width:900px}}.topin{{height:50px;display:flex;align-items:center;justify-content:space-between}}.brand{{font-weight:750;display:flex;align-items:center;gap:9px}}.logo{{width:26px;height:26px;border-radius:8px;background:var(--text);color:var(--bg);display:grid;place-items:center;font-size:12px}}.nav{{display:flex;gap:4px;padding:4px;background:var(--panel);border:1px solid var(--line);border-radius:10px}}.nav a{{min-height:30px;padding:0 10px;display:flex;align-items:center;border-radius:7px;color:var(--dim);font-weight:650}}.nav a.active{{background:var(--blue2);color:var(--blue)}}
